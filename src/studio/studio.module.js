...
StudioModule = __decorate([
    common_1.Module({
        imports: [
            ...
            typeorm_1.TypeOrmModule.forFeature([studio_entity_1.Studio, flag_studio_entity_1.FlagStudio]),
        ],
        controllers: [studio_controller_1.StudioController],
        providers: [studio_service_1.StudioService],
        exports: [typeorm_1.TypeOrmModule, studio_service_1.StudioService],
    })
], StudioModule);
